...
const Item = ({title, to, icon, seklected, setSelected}) => {
const theme = useTheme();
const colors = tokens(theme.pal)
}
...
export default function Sidebar() {
  ...
  return (
    <Box backgroundColor="#1F2A40" padding= "5px 35px 5px 20px" sx={{
      "& .pro-sidebar-inner": {
          ...
          {!isCollapsed && (
            <Box mb='25px' display='flex' justifyContent='center' alignItems='center'>
              ...
              <Box textAlign='center'>
                ...
                sx={{ m: "10px 0 0 0"}}>Tomi</Typography>
                <Typography
